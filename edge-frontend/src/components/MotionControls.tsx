...
export function MotionControls({ onJog, onHome, stepSize, setStepSize, userRole, alignState }: MotionControlsProps) {
    ...
    return (
        <div className={cn("bg-zinc-900 rounded-xl p-4 border border-zinc-800 flex flex-col items-center gap-4 transition-opacity",
            ...
            <div className="grid grid-cols-3 gap-2">
                ...
                <button onClick={onHome} className="w-14 h-12 bg-yellow-900/20 text-yellow-500 rounded flex items-center justify-center border border-yellow-700/50 hover:bg-yellow-900/40 active:scale-95"><Home size={18} /></button>
