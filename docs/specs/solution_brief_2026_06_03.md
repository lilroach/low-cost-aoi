...
- 低成本建置
  - 預計效果: 以約 NT$18,000 到 NT$23,500 完成含 Pi、相機、邊緣 AI、基礎運動控制的第一版硬體估算；若採較正式 USB3 工業相機，預算上緣需上修。
  - 驗收方式: BOM 與採購單比對。
- 現場取像
...
- Phase 4 自動掃描版
  - 內容: Phase 3 + SKR Pico、CoreXY 機構、馬達、皮帶、拖鏈、限位、24V 電源。
  - 預估總額: 約 NT$18,000 到 NT$23,500。
- USB3 工業相機版
  - 內容: Phase 4 改採 USB3 工業 IMX296 相機。
  - 預估總額: 約 NT$21,500 到 NT$27,000。
